    ...
    <div>
     ...
     <Banner />
      ...
      <div className='border border-blue rounded-2xl p-10 m-32'>
                ...
                <div>
                    <img className="w-1/3 h-auto justify-center " src="https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg" alt="Rounded avatar" />
                </div>
            ...
            <div className="p-2 mx-32 mb-6 flex justify-between ">
                ...
                <div className="flex-grow relative w-3/4">
                    <textarea className=" h-52 w-full p-2 border border-blue rounded-md resize-none" placeholder="Add your comments"></textarea>
