      ...
      <div className='flex justify-between mr-32 ml-32 mt-32'>
        <div className='w-1/2 mr-12 mt-12 shadow-xl p-12'>
          ...
          <div className='flex justify-end'>
            <div className='flex items-center justify-center rounded-full w-20 h-20 bg-yellow' onClick={openModal}>
          ...
          <div className="modal-box max-w-5xl p-14">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='mb-4'>
                ...
                <input type='email' className='w-full rounded-xl p-2 border border-blue focus:border-yellow' defaultValue='kevin1000@gmail.com' />
              </div>
              <div className='mb-4'>
                <label className='block text-2xl font-medium mb-2'>Contact Number</label>
                <input type='text' className='w-full rounded-xl p-2 border border-blue focus:border-yellow' />
              </div>
              <div className='mb-4'>
