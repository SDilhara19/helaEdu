...
const HomeBanner = () => {
    return (
        <>
            <div className='flex mb-4' style={{ backgroundImage: `url(${banner})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className='flex-col'>
                    ...
                    <div className='icon-circle'>
                        <FontAwesomeIcon icon={faClockRotateLeft} size="3x" className="black" />
                    </div>
                </div>
