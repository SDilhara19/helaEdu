  ...
  return (
    <>
      <div className="bg-white max-w-4xl mx-auto py-8 shadow-2xl rounded-xl border relative mt-10">
        <div className="absolute top-12 left-6 text-blue">
          <BackKey click={clickBack} />
        </div>
        <h3 className="special-text text-blue text-center -mb-2">
          Start Your Weekly {subject} Quiz!
        </h3>
        ...
        <div className="w-full p-2">
          <div className="flex items-center m-4">
            <FontAwesomeIcon
              ...
              className="mx-5"
            />
            <p className="n-text">The quiz will have 5 questions</p>
          </div>
          <div className="flex items-center m-4">
            <FontAwesomeIcon
              icon={faBookOpen}
          ...
          <div className="flex items-center m-4">
            ...
            />
            <p className="n-text">
              You will be given 60 seconds for each question
            </p>
          </div>
          <div className="flex items-center m-4">
            <FontAwesomeIcon
            ...
            />
            <p className="n-text">
              Each correct answer will add one mark to your total score
            </p>
          </div>
          <div className="flex items-center m-4">
            <FontAwesomeIcon
            ...
            />
            <p className="n-text">
              Total time taken in each quiz will be considered in final rankings
            </p>
          </div>
