    ...
    <div>
      <div className="card bg-base-100 w-96 shadow-xl hover:scale-105 transition-transform">
        ...
        <div className="card-body">
          ...
          <FontAwesomeIcon icon={faCommentRegular} className='text-xl size-10 my-2' style={{ color: "#74C0FC", cursor: 'pointer' }}  onMouseEnter={(e) => e.currentTarget.style.transform = 'translateY(-2px)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'translateY(0)'}/><span className='text-blue'>45</span>
